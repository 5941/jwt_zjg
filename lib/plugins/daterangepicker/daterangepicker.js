    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            if (typeof options.dateLimit === 'object'){
                this.dateLimitMin = options.dateLimit;
                this.dateLimitMax = options.dateLimit;
            }
            
            if (typeof options.dateLimitMax === 'object')
                this.dateLimitMax = options.dateLimitMax;
        ...
        clickDate: function (e) {
            ...
            if (cal.hasClass('left')) {
                ...
                endDate = this.endDate;
                if (typeof this.dateLimitMax === 'object') {
                    var endTime = moment(endDate).format('HH:mm:ss');
                    var maxDate = moment(startDate).add(this.dateLimitMax).startOf('day');
                    if (endDate.isAfter(maxDate)) {
                        endDate = moment(moment(maxDate).format('YYYY-MM-DD')+' ' +endTime);
                    }
                }
                ...
                if (typeof this.dateLimitMin === 'object') {
                    ...
                    if (endDate.isBefore(minDate)) {
                        endDate = moment(moment(minDate).format('YYYY-MM-DD')+' ' +endTime);
                    }
                }
            } else {
                startDate = this.startDate;
                ...
                if (typeof this.dateLimitMax === 'object') {
                    var minDate = moment(endDate).subtract(this.dateLimitMax).startOf('day');
